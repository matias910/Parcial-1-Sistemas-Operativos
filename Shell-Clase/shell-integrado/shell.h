...
/* --- Categoría: Edición de Texto (cat_edicion.c) --- CATEGORÍA NUEVA ---
 * Integra el editor de texto del Parcial 1 (o/p/a/d/i/s/q). Es una
 * categoría nueva (no 'datos' ni 'monitoreo') porque, a diferencia del
 * resto de comandos del shell, necesita apropiarse de la entrada
 * estándar en un ciclo interactivo propio hasta que el usuario escriba
 * 'q'. Ver la justificación completa en cat_edicion.c y en el PDF de
 * sustentación. */
int cmd_e_editor(int argc, char **argv);  /* Syscalls: fork, execvp, waitpid */
