...
Command commands[] = {
    ...
    /* --- Categoría: Edición de Texto --- CATEGORÍA NUEVA (Parcial 1 SO) --- */
    {
        "e_editor", "edicion",
        "e_editor [archivo]",
        "Abre el editor de texto interactivo del Parcial 1 (o/p/a/d/i/s/q). "
        "Si se da un archivo, lo abre directamente al iniciar.",
        "fork(2), execvp(3), waitpid(2)",
        cmd_e_editor
    }
};
...
void print_help(const char *arg) {
    if (arg == NULL) {
        ...
        printf("  " COLOR_CATEGORY "edicion" COLOR_RESET "    - Editor de texto interactivo del Parcial 1 (e_editor)\n\n");
        printf("Uso general:\n");
